...
#define MATCH_PADDB 0x48000077
#define MASK_PADDB 0xfe00707f
#define MATCH_PAADDB 0x8000077
#define MASK_PAADDB 0xfe00707f
#define MATCH_PAADDUB 0x28000077
#define MASK_PAADDUB 0xfe00707f
#define MATCH_PSADDUB 0x38000077
#define MASK_PSADDUB 0xfe00707f
#define MATCH_PSUBB 0x4a000077
#define MASK_PSUBB 0xfe00707f
#define MATCH_PASUBB 0xa000077
#define MASK_PASUBB 0xfe00707f
#define MATCH_PASUBUB 0x2a000077
#define MASK_PASUBUB 0xfe00707f
#define MATCH_PSSUBB 0x1a000077
#define MASK_PSSUBB 0xfe00707f
#define MATCH_PSSUBUB 0x3a000077
#define MASK_PSSUBUB 0xfe00707f
#define MATCH_PADDH 0x40000077
#define MASK_PADDH 0xfe00707f
#define MATCH_PAADDH 0x77
#define MASK_PAADDH 0xfe00707f
#define MATCH_PAADDUH 0x20000077
#define MASK_PAADDUH 0xfe00707f
#define MATCH_PSADDH 0x10000077
#define MASK_PSADDH 0xfe00707f
#define MATCH_PSADDUH 0x30000077
#define MASK_PSADDUH 0xfe00707f
#define MATCH_PSUBH 0x42000077
#define MASK_PSUBH 0xfe00707f
#define MATCH_PASUBH 0x2000077
#define MASK_PASUBH 0xfe00707f
#define MATCH_PASUBUH 0x22000077
#define MASK_PASUBUH 0xfe00707f
#define MATCH_PSSUBH 0x12000077
#define MASK_PSSUBH 0xfe00707f
#define MATCH_PSSUBUH 0x32000077
#define MASK_PSSUBUH 0xfe00707f
#define MATCH_PASHX 0x44000077
#define MASK_PASHX 0xfe00707f
#define MATCH_PAASHX 0x4000077
#define MASK_PAASHX 0xfe00707f
#define MATCH_PSASHX 0x14000077
#define MASK_PSASHX 0xfe00707f
#define MATCH_PSAHX 0x46000077
#define MASK_PSAHX 0xfe00707f
#define MATCH_PASAHX 0x6000077
#define MASK_PASAHX 0xfe00707f
#define MATCH_PSSAHX 0x16000077
#define MASK_PSSAHX 0xfe00707f
#define MATCH_PMSEQH 0x4c000077
#define MASK_PMSEQH 0xfe00707f
#define MATCH_PMSLTH 0xc000077
#define MASK_PMSLTH 0xfe00707f
#define MATCH_PMSLTUH 0x2c000077
#define MASK_PMSLTUH 0xfe00707f
#define MATCH_PMSLEH 0x1c000077
#define MASK_PMSLEH 0xfe00707f
#define MATCH_PMSLEUH 0x3c000077
#define MASK_PMSLEUH 0xfe00707f
#define MATCH_PMINH 0x80000077
#define MASK_PMINH 0xfe00707f
#define MATCH_PMINUH 0x90000077
#define MASK_PMINUH 0xfe00707f
#define MATCH_PMAXH 0x82000077
#define MASK_PMAXH 0xfe00707f
#define MATCH_PMAXUH 0x92000077
#define MASK_PMAXUH 0xfe00707f
#define MATCH_PCLIPH 0x84000077
#define MASK_PCLIPH 0xff00707f
#define MATCH_PCLIPUH 0x85000077
#define MASK_PCLIPUH 0xff00707f
#define MATCH_PABSH 0xad100077
#define MASK_PABSH 0xfff0707f
#define MATCH_SMAQA 0xc8000077
#define MASK_SMAQA 0xfe00707f
#define MATCH_UMAQA 0xcc000077
#define MASK_UMAQA 0xfe00707f
#define MATCH_SMAQASU 0xca000077
#define MASK_SMAQASU 0xfe00707f
...
/* RVP instructions */
DECLARE_INSN(paddb, MATCH_PADDB, MASK_PADDB)
DECLARE_INSN(paaddb, MATCH_PAADDB, MASK_PAADDB)
DECLARE_INSN(paaddub, MATCH_PAADDUB, MASK_PAADDUB)
DECLARE_INSN(psaddub, MATCH_PSADDUB, MASK_PSADDUB)
DECLARE_INSN(psubb, MATCH_PSUBB, MASK_PSUBB)
DECLARE_INSN(pasubb, MATCH_PASUBB, MASK_PASUBB)
DECLARE_INSN(pasubub, MATCH_PASUBUB, MASK_PASUBUB)
DECLARE_INSN(pssubb, MATCH_PSSUBB, MASK_PSSUBB)
DECLARE_INSN(pssubub, MATCH_PSSUBUB, MASK_PSSUBUB)
DECLARE_INSN(paddh, MATCH_PADDH, MASK_PADDH)
DECLARE_INSN(paaddh, MATCH_PAADDH, MASK_PAADDH)
DECLARE_INSN(paadduh, MATCH_PAADDUH, MASK_PAADDUH)
DECLARE_INSN(psaddh, MATCH_PSADDH, MASK_PSADDH)
DECLARE_INSN(psadduh, MATCH_PSADDUH, MASK_PSADDUH)
DECLARE_INSN(psubh, MATCH_PSUBH, MASK_PSUBH)
DECLARE_INSN(pasubh, MATCH_PASUBH, MASK_PASUBH)
DECLARE_INSN(pasubuh, MATCH_PASUBUH, MASK_PASUBUH)
DECLARE_INSN(pssubh, MATCH_PSSUBH, MASK_PSSUBH)
DECLARE_INSN(pssubuh, MATCH_PSSUBUH, MASK_PSSUBUH)
DECLARE_INSN(pashx, MATCH_PASHX, MASK_PASHX)
DECLARE_INSN(paashx, MATCH_PAASHX, MASK_PAASHX)
DECLARE_INSN(psashx, MATCH_PSASHX, MASK_PSASHX)
DECLARE_INSN(psahx, MATCH_PSAHX, MASK_PSAHX)
DECLARE_INSN(pasahx, MATCH_PASAHX, MASK_PASAHX)
DECLARE_INSN(pssahx, MATCH_PSSAHX, MASK_PSSAHX)
DECLARE_INSN(pmseqh, MATCH_PMSEQH, MASK_PMSEQH)
DECLARE_INSN(pmslth, MATCH_PMSLTH, MASK_PMSLTH)
DECLARE_INSN(pmsltuh, MATCH_PMSLTUH, MASK_PMSLTUH)
DECLARE_INSN(pmsleh, MATCH_PMSLEH, MASK_PMSLEH)
DECLARE_INSN(pmsleuh, MATCH_PMSLEUH, MASK_PMSLEUH)
DECLARE_INSN(pminh, MATCH_PMINH, MASK_PMINH)
DECLARE_INSN(pminuh, MATCH_PMINUH, MASK_PMINUH)
DECLARE_INSN(pmaxh, MATCH_PMAXH, MASK_PMAXH)
DECLARE_INSN(pmaxuh, MATCH_PMAXUH, MASK_PMAXUH)
DECLARE_INSN(pcliph, MATCH_PCLIPH, MASK_PCLIPH)
DECLARE_INSN(pclipuh, MATCH_PCLIPUH, MASK_PCLIPUH)
DECLARE_INSN(pabsh, MATCH_PABSH, MASK_PABSH)
DECLARE_INSN(smaqa, MATCH_SMAQA, MASK_SMAQA)
DECLARE_INSN(umaqa, MATCH_UMAQA, MASK_UMAQA)
DECLARE_INSN(smaqasu, MATCH_SMAQASU, MASK_SMAQASU)
/* Zicbop instructions.  */
